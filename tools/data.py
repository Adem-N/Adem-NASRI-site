...
},
{
 ...
 "visuel_legende": "chalery.fr/produits — l'univers du plan technique : filets d'un pixel, marques d'angle, schémas cotés.",
 "page2_label": "chalery.fr/simulateur", "page2_legende": "Le simulateur : le plan de coupe se dessine au fil des réponses, cartouche « Éch. 1:100 · CHY-01 » comprise.",
...
},
{
 ...
 "page2_label": "malamourrrrrr.com/products", "page2_legende": "La fiche produit refaite : sélecteur de packs 1 / 3 / 6, galerie de neuf miniatures, description longue.",
